...
- **Advanced bibliometric analysis on safety of hydrogen energy**  
  Zhang D., Jiang M., Li G.  
  *Journal of Energy Storage, 2024*

- **Direct numerical simulation of drag, lift and torque of biomass cylindrical particles**  
  Wang J., Ma L., Jiang M.  
  *Physics of Fluids, 2024*

- **Hydrodynamic force and torque models for cylindrical particles**  
  Wang J., Chen X., Ma L., Jiang M.  
  *Physics of Fluids, 2024*

- **基于相场–格子Boltzmann方法的铝液滴碰撞行为模拟**  
  吴宇晨, 江茂强  
  *工程热物理学报, 2024*
...
- **Fully resolved simulations of viscoelastic suspensions**  
  Qin S., Jiang M., Ma K.  
  *Particuology, 2023*

- **A one-step index algorithm for LBM on GPU**  
  Ma K., Wang Y., Jiang M.  
  *Computer Physics Communications, 2023*

- **Accelerating particle-laden flow simulations on heterogeneous architectures**  
  Ma K., Jiang M., Liu Z.  
  *Particuology, 2023*
...
- **Parallel immersed boundary-lattice Boltzmann method for settling suspensions**  
  Jiang M., Li J., Liu Z.  
  *Computers & Fluids, 2022*

- **Hydrodynamic simulation of char particle combustion**  
  Jiang M., Ma K., Li J.  
  *International Communications in Heat and Mass Transfer, 2022*

- **Pressure compensation method for particle-laden flows**  
  Jiang M., Liu Z.  
...
- **Inertial migration of aerosol particles in microfluidic channels**  
...
- **A boundary thickening-based immersed boundary method for particle-laden flows**  
  Jiang M., Liu Z.  
